...
<style lang='scss'>
  .widgetSlot {
    ...
    display: flex;
    border-radius: 10px;
    background: linear-gradient(135deg, #fffbe8, #ffffff, #fbffc6);
    @media (prefers-color-scheme: dark) {
      background: linear-gradient(135deg, #ffe15b, #fff9ab, #fffc5d);
    }
